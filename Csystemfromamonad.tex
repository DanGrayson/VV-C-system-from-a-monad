...
\hfill\break\centerline{\tiny{\tt c856a56a1eec07c4b5a742bcc7c7b6b02c2d4c33}.}
...
A {\em monad in Kleisli form}\editorfootnote{formalized as the type {\tt Kleisli} in \cite{UniMath}, file {\tt Kleisli.v}.} on a category $\C$ is a triple $$\RR=(RR_{Ob},\eta,rr),$$ where 
%
\begin{enumerate}
