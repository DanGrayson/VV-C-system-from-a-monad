...
existing body of work on type theory, as reflected in \cite[Theorem
  1.2.9]{KLV1}.\editorfootnote{Statement 1.2.9 of \cite{KLV1} was a theorem in version
  4 of the preprint, but in version 5, posted a year after the death of Voevodsky,
  it was stated as a conjecture.  It states that the C-system (contextual category) associated to
