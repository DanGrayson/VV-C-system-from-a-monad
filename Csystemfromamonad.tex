...
\begin{definition}
  ...
  A {\em monad in monoidal form} on a category $\C$ is a triple $\R=(R,\eta,\mu)$,
...
A {\em monad in Kleisli form} on a category $\C$ is a triple $$\RR=(RR_{Ob},\eta,rr),$$ where 
%
\begin{enumerate}
...
Let $J:\C\sr \D$ be a functor. A {\em relative monad} $\RR$ on $J$ (or a $J$-relative monad, or a $J$-monad) is a triple $(RR_{Ob},\eta,rr)$, where
%
\begin{enumerate}
