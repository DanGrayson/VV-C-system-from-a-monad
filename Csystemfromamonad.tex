...
\editorfootnote{Why is this true? Doesn't it depend on the precise form of the set of inference rules?}
...
$\Gamma\rh T\type$ and $\Gamma\rh T'\type$.\editorfootnote{Why is this true? Doesn't it depend
on the precise form of the set of inference rules?}  The validity of
...
assertion\editorfootnote{What assertion?} can be expressed in the form of a pair of inference rules:%
\editorfootnote{This paragraph seems to have been marked ``incomplete'' by the author.
  I'll remove it.}
%
$$
