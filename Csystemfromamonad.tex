...
\glsxtrnewsymbol[description={a functor from the Kleisli category of a relative monad $\RR$}]{RRlm}{\ensuremath{\RR^{lm}}}
...
\glsxtrnewsymbol[description={the functor induced on Kleisli categories by restriction of a relative monad $\RR$}]{F_RR}{\ensuremath{F_{\RR}}}
...
\glsxtrnewsymbol[description={the relative monad induced on a factor $\D$ from a relative monad $\RR$}]{RR_D}{\ensuremath{\RR_{\D}}}
\glsxtrnewsymbol[description={the monad induced on the first factor of a product by a monad $\RR$}]{RR1A}{\ensuremath{\RR_{1,A}}}
\glsxtrnewsymbol[description={the monad induced on the second factor of a product by a monad $\RR$}]{RR2A}{\ensuremath{\RR_{2,A}}}
...
\glsxtrnewsymbol[description={the object of $C(\RR)$ associated to the natural number $m$}]{whm}{\ensuremath{\wh{m}}}
...
table\BA{The referenced thing is not a table. Need to figure out what is meant.} (\ref{2017.04.07.eq1}) are in $Beq$.
...
% I can't figure out what reference is intended here. -- DRG
%(cf.{} \cite{Bsystemsnew})
...
conditions are shown in Proposition X.A\DG{Apparently this proposition was not added to the paper.} of the present paper to be
...
we define, in Construction X.B\DG{Apparently this construction was not added to the paper.}, a pre-B-system structure on the sets
$(B(\RR,\LM),\wt{B}(\RR,\LM))$ and, in Construction X.C\DG{Apparently this construction was not added to the paper.}, an isomorphism
...
Summing it up in Construction X.D\DG{Apparently this construction was not added to the paper.} we obtain a construction, for any four
...
Kleisli form''. To the best of my knowledge it appeared explicitly first
...
such places $\gls{whm}$ instead of $m$, $\wh{n}$ instead of $n$, etc.
