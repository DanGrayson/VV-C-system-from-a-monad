...
conditions\DG{insert these three conditions here?} (see \cite[Proposition 5.4]{Csubsystems}) that involve the length
function $l:B\sr\nat$ on $B$.
...
of this type theory to be defined.\DG{This is the end of the part to ignore.}
