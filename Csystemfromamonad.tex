...
\glsxtrnewsymbol[description={the monad induced on a factor from a monad $\RR$}]{RR1A}{\ensuremath{\RR_{1,A}}}
...
Following \cite{ACU} we let $\gls{Jf}:F\sr Sets$ denote the functor that takes $\ff n$ to
