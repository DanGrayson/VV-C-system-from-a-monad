...
monad on $\C$, and $L:\C\sr \E$ be a functor. A (left) $\R$-module structure on
...
Let $\C$, $\D$, $\D'$ be categories, $J:\C\sr \D\times\D'$ be a functor, and $\RR=(RR,\eta,rr)$ be a $J$-relative monad.
